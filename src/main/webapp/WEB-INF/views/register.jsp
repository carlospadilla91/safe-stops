      ...
      <div class="container" ng-controller="HomeController as ctrl">
          <div class="panel panel-default">
              ...
              <div class="formcontainer">
                  <form ng-submit="ctrl.submit()" name="safeStopForm" class="form-horizontal">
                      ...
                      <div class="row">
                          <div class="form-actions floatRight">
                              <input type="submit"  value="{{!ctrl.user.id ? 'Add' : 'Update'}}" class="btn btn-primary btn-sm" ng-disabled="safeStopForm.$invalid">
                              <button type="button" ng-click="ctrl.reset()" class="btn btn-warning btn-sm" ng-disabled="safeStopFOrm.$pristine">Reset Form</button>
                          </div>
                      </div>
                  </form>
              </div>
